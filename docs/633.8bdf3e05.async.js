"use strict";(self.webpackChunkreact_ui=self.webpackChunkreact_ui||[]).push([[633],{53633:function(lt,O,i){i.r(O),i.d(O,{VirtualList:function(){return R},VirtualTable:function(){return tt}});var B=i(54306),A=i.n(B),D=i(50959),e=i(11527),F=function(t){var r=t.idx,n=t.stripe,l=t.style,c=t.item;return(0,e.jsx)("div",{className:n?r%2?"list list-item-odd":"list list-item-even":"list",style:l,children:c.name})},G=F,J=i(92935),z=i.n(J),k=i(67216),E,K=k.ZP.div(E||(E=z()([`
  overflow: auto;
  .virtual-list {
    position: relative;
...
`]))),Q=function(t){var r=t.height,n=r===void 0?300:r,l=t.width,c=l===void 0?600:l,d=t.itemHeight,a=d===void 0?30:d,o=t.stripe,v=o===void 0?!1:o,m=t.listData,x=t.onScroll,H=(0,D.useState)(0),b=A()(H,2),p=b[0],w=b[1],y=m.length,V=function(){for(var s=Math.floor(p/a),f=Math.max(0,s-2),$=Math.ceil(n/a),I=Math.min(y,s+$+3),g=[],h=f;h<I;h++){var N={height:a,top:a*h};g.push((0,e.jsx)(G,{idx:h,stripe:v,style:N,item:m[h]},h+Math.random()))}return g},S=function(s){var f=s.currentTarget.scrollTop;w(f),x(s)};return(0,e.jsx)(K,{children:(0,e.jsx)("div",{className:"virtual-list",style:{width:c,height:n},onScroll:S,children:V()})})},R=Q,U=i(57213),P=i.n(U),W,X=k.ZP.div(W||(W=z()([`
  .virtual-table {
    border: 1px solid #dedede;
    color: #333;
    width: 100%;
