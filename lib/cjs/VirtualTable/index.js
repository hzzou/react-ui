...
var VirtualTable = (props) => {
  ...
  return /* @__PURE__ */ import_react.default.createElement(import_styles.default, null, /* @__PURE__ */ import_react.default.createElement("div", { className: "virtual-table" }, /* @__PURE__ */ import_react.default.createElement(
    "article",
    {
      style: { height },
