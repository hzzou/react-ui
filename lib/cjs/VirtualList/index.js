...
var VirtualList = (props) => {
  const { height = 300, width = 600, itemHeight = 30, stripe = false, listData, onScroll } = props;
  const [scrollOffset, setScrolllOffset] = (0, import_react.useState)(0), itemCount = listData.length;
  const getChildren = () => {
    ...
    for (let i = finialStartIdx; i < endIdx; i++) {
      ...
      items.push(
        /* @__PURE__ */ import_react.default.createElement(import_listItem.default, { key: i + Math.random(), idx: i, stripe, style: itemStyle, item: listData[i] })
      );
    }
    return items;
  };
  ...
  return /* @__PURE__ */ import_react.default.createElement(import_styles.StylesWrapper, null, /* @__PURE__ */ import_react.default.createElement("div", { className: "virtual-list", style: { width, height }, onScroll: handleScroll }, getChildren()));
};
